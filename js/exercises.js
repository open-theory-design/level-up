...
(function () {
  ...
  window.PF_EXERCISES = [
    ...
    { id: "quad_roll",          name: "Quad Foam Roll",              dose: "60–90s per leg",  track: { type: "hold", sets: 2, secs: 60, min: 45, max: 120 }, tips: ["Roll slowly — 2–4 seconds per pass", "Work from the hip down to just above the knee", "Pause on tender spots and keep breathing"], avoid: ["Rolling over your kneecap or hip bone", "Going past 2 minutes on one leg"] },
